      ...
      <Card className="w-full max-w-md z-10 border-slate-100 bg-white shadow-xl">
        ...
        <form action={signup}>
          ...
          <CardFooter className="flex flex-col space-y-4 pt-4">
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98] rounded-xl">
              Create Account
            </Button>
